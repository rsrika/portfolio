        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col">
                    ...
                    <br/><br/>
                    Right now, I just finished a software development internship at Amazon, where I learned to use server-side tools, and put them to use in a production-level environment. As I finish my college career, I plan on furthering my skills in React and server-side development, so I can build better experiences for everyone.     
                    <br/><br/>
